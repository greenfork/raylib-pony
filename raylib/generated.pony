...
use @PonyGetMouseRay[Ray](mousePosition: Pointer[V2] tag, camera: Camera)
use @PonyGetCameraMatrix[Matrix](camera: Camera)
use @PonyGetCameraMatrix2D[Matrix](camera: Camera2D)
use @PonyGetWorldToScreen[Vector2](position: Pointer[V3] tag, camera: Camera)
use @PonyGetScreenToWorld2D[Vector2](position: Pointer[V2] tag, camera: Camera2D)
use @PonyGetWorldToScreenEx[Vector2](position: Pointer[V3] tag, camera: Camera, width: I32, height: I32)
use @PonyGetWorldToScreen2D[Vector2](position: Pointer[V2] tag, camera: Camera2D)
...
use @PonyUpdateCameraPro[None](camera: Camera, movement: Pointer[V3] tag, rotation: Pointer[V3] tag, zoom: F32)
...
use @PonyDrawPixelV[None](position: Pointer[V2] tag, color: Color)
use @PonyDrawLine[None](startPosX: I32, startPosY: I32, endPosX: I32, endPosY: I32, color: Color)
use @PonyDrawLineV[None](startPos: Pointer[V2] tag, endPos: Pointer[V2] tag, color: Color)
use @PonyDrawLineEx[None](startPos: Pointer[V2] tag, endPos: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawLineStrip[None](points: Pointer[Vector2] tag, pointCount: I32, color: Color)
use @PonyDrawLineBezier[None](startPos: Pointer[V2] tag, endPos: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawCircle[None](centerX: I32, centerY: I32, radius: F32, color: Color)
use @PonyDrawCircleSector[None](center: Pointer[V2] tag, radius: F32, startAngle: F32, endAngle: F32, segments: I32, color: Color)
use @PonyDrawCircleSectorLines[None](center: Pointer[V2] tag, radius: F32, startAngle: F32, endAngle: F32, segments: I32, color: Color)
use @PonyDrawCircleGradient[None](centerX: I32, centerY: I32, radius: F32, color1: Color, color2: Color)
use @PonyDrawCircleV[None](center: Pointer[V2] tag, radius: F32, color: Color)
use @PonyDrawCircleLines[None](centerX: I32, centerY: I32, radius: F32, color: Color)
use @PonyDrawCircleLinesV[None](center: Pointer[V2] tag, radius: F32, color: Color)
...
use @PonyDrawRing[None](center: Pointer[V2] tag, innerRadius: F32, outerRadius: F32, startAngle: F32, endAngle: F32, segments: I32, color: Color)
use @PonyDrawRingLines[None](center: Pointer[V2] tag, innerRadius: F32, outerRadius: F32, startAngle: F32, endAngle: F32, segments: I32, color: Color)
use @PonyDrawRectangle[None](posX: I32, posY: I32, width: I32, height: I32, color: Color)
use @PonyDrawRectangleV[None](position: Pointer[V2] tag, size: Pointer[V2] tag, color: Color)
use @PonyDrawRectangleRec[None](rec: Rectangle, color: Color)
use @PonyDrawRectanglePro[None](rec: Rectangle, origin: Pointer[V2] tag, rotation: F32, color: Color)
...
use @PonyDrawTriangle[None](v1: Pointer[V2] tag, v2: Pointer[V2] tag, v3: Pointer[V2] tag, color: Color)
use @PonyDrawTriangleLines[None](v1: Pointer[V2] tag, v2: Pointer[V2] tag, v3: Pointer[V2] tag, color: Color)
...
use @PonyDrawPoly[None](center: Pointer[V2] tag, sides: I32, radius: F32, rotation: F32, color: Color)
use @PonyDrawPolyLines[None](center: Pointer[V2] tag, sides: I32, radius: F32, rotation: F32, color: Color)
use @PonyDrawPolyLinesEx[None](center: Pointer[V2] tag, sides: I32, radius: F32, rotation: F32, lineThick: F32, color: Color)
...
use @PonyDrawSplineSegmentLinear[None](p1: Pointer[V2] tag, p2: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawSplineSegmentBasis[None](p1: Pointer[V2] tag, p2: Pointer[V2] tag, p3: Pointer[V2] tag, p4: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawSplineSegmentCatmullRom[None](p1: Pointer[V2] tag, p2: Pointer[V2] tag, p3: Pointer[V2] tag, p4: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawSplineSegmentBezierQuadratic[None](p1: Pointer[V2] tag, c2: Pointer[V2] tag, p3: Pointer[V2] tag, thick: F32, color: Color)
use @PonyDrawSplineSegmentBezierCubic[None](p1: Pointer[V2] tag, c2: Pointer[V2] tag, c3: Pointer[V2] tag, p4: Pointer[V2] tag, thick: F32, color: Color)
use @PonyGetSplinePointLinear[Vector2](startPos: Pointer[V2] tag, endPos: Pointer[V2] tag, t: F32)
use @PonyGetSplinePointBasis[Vector2](p1: Pointer[V2] tag, p2: Pointer[V2] tag, p3: Pointer[V2] tag, p4: Pointer[V2] tag, t: F32)
use @PonyGetSplinePointCatmullRom[Vector2](p1: Pointer[V2] tag, p2: Pointer[V2] tag, p3: Pointer[V2] tag, p4: Pointer[V2] tag, t: F32)
use @PonyGetSplinePointBezierQuad[Vector2](p1: Pointer[V2] tag, c2: Pointer[V2] tag, p3: Pointer[V2] tag, t: F32)
use @PonyGetSplinePointBezierCubic[Vector2](p1: Pointer[V2] tag, c2: Pointer[V2] tag, c3: Pointer[V2] tag, p4: Pointer[V2] tag, t: F32)
use @PonyCheckCollisionRecs[Bool](rec1: Rectangle, rec2: Rectangle)
use @PonyCheckCollisionCircles[Bool](center1: Pointer[V2] tag, radius1: F32, center2: Pointer[V2] tag, radius2: F32)
use @PonyCheckCollisionCircleRec[Bool](center: Pointer[V2] tag, radius: F32, rec: Rectangle)
use @PonyCheckCollisionPointRec[Bool](point: Pointer[V2] tag, rec: Rectangle)
use @PonyCheckCollisionPointCircle[Bool](point: Pointer[V2] tag, center: Pointer[V2] tag, radius: F32)
use @PonyCheckCollisionPointTriangle[Bool](point: Pointer[V2] tag, p1: Pointer[V2] tag, p2: Pointer[V2] tag, p3: Pointer[V2] tag)
use @PonyCheckCollisionPointPoly[Bool](point: Pointer[V2] tag, points: Pointer[Vector2] tag, pointCount: I32)
use @PonyCheckCollisionLines[Bool](startPos1: Pointer[V2] tag, endPos1: Pointer[V2] tag, startPos2: Pointer[V2] tag, endPos2: Pointer[V2] tag, collisionPoint: Pointer[V2] tag)
use @PonyCheckCollisionPointLine[Bool](point: Pointer[V2] tag, p1: Pointer[V2] tag, p2: Pointer[V2] tag, threshold: I32)
...
use @PonyImageDrawPixelV[None](dst: Image, position: Pointer[V2] tag, color: Color)
use @PonyImageDrawLine[None](dst: Image, startPosX: I32, startPosY: I32, endPosX: I32, endPosY: I32, color: Color)
use @PonyImageDrawLineV[None](dst: Image, start: Pointer[V2] tag, end': Pointer[V2] tag, color: Color)
use @PonyImageDrawCircle[None](dst: Image, centerX: I32, centerY: I32, radius: I32, color: Color)
use @PonyImageDrawCircleV[None](dst: Image, center: Pointer[V2] tag, radius: I32, color: Color)
use @PonyImageDrawCircleLines[None](dst: Image, centerX: I32, centerY: I32, radius: I32, color: Color)
use @PonyImageDrawCircleLinesV[None](dst: Image, center: Pointer[V2] tag, radius: I32, color: Color)
use @PonyImageDrawRectangle[None](dst: Image, posX: I32, posY: I32, width: I32, height: I32, color: Color)
use @PonyImageDrawRectangleV[None](dst: Image, position: Pointer[V2] tag, size: Pointer[V2] tag, color: Color)
...
use @PonyImageDrawTextEx[None](dst: Image, font: Font, text: Pointer[U8] tag, position: Pointer[V2] tag, fontSize: F32, spacing: F32, tint: Color)
...
use @PonyDrawTextureV[None](texture: Texture2D, position: Pointer[V2] tag, tint: Color)
use @PonyDrawTextureEx[None](texture: Texture2D, position: Pointer[V2] tag, rotation: F32, scale: F32, tint: Color)
use @PonyDrawTextureRec[None](texture: Texture2D, source: Rectangle, position: Pointer[V2] tag, tint: Color)
use @PonyDrawTexturePro[None](texture: Texture2D, source: Rectangle, dest: Rectangle, origin: Pointer[V2] tag, rotation: F32, tint: Color)
use @PonyDrawTextureNPatch[None](texture: Texture2D, nPatchInfo: NPatchInfo, dest: Rectangle, origin: Pointer[V2] tag, rotation: F32, tint: Color)
use @PonyFade[Color](color: Color, alpha: F32)
use @PonyColorToInt[I32](color: Color)
use @PonyColorNormalize[Vector4](color: Color)
use @PonyColorFromNormalized[Color](normalized: Pointer[V4] tag)
...
use @PonyDrawTextEx[None](font: Font, text: Pointer[U8] tag, position: Pointer[V2] tag, fontSize: F32, spacing: F32, tint: Color)
use @PonyDrawTextPro[None](font: Font, text: Pointer[U8] tag, position: Pointer[V2] tag, origin: Pointer[V2] tag, rotation: F32, fontSize: F32, spacing: F32, tint: Color)
use @PonyDrawTextCodepoint[None](font: Font, codepoint: I32, position: Pointer[V2] tag, fontSize: F32, tint: Color)
use @PonyDrawTextCodepoints[None](font: Font, codepoints: Pointer[I32] tag, codepointCount: I32, position: Pointer[V2] tag, fontSize: F32, spacing: F32, tint: Color)
...
use @PonyDrawLine3D[None](startPos: Pointer[V3] tag, endPos: Pointer[V3] tag, color: Color)
use @PonyDrawPoint3D[None](position: Pointer[V3] tag, color: Color)
use @PonyDrawCircle3D[None](center: Pointer[V3] tag, radius: F32, rotationAxis: Pointer[V3] tag, rotationAngle: F32, color: Color)
use @PonyDrawTriangle3D[None](v1: Pointer[V3] tag, v2: Pointer[V3] tag, v3: Pointer[V3] tag, color: Color)
use @PonyDrawTriangleStrip3D[None](points: Pointer[Vector3] tag, pointCount: I32, color: Color)
use @PonyDrawCube[None](position: Pointer[V3] tag, width: F32, height: F32, length: F32, color: Color)
use @PonyDrawCubeV[None](position: Pointer[V3] tag, size: Pointer[V3] tag, color: Color)
use @PonyDrawCubeWires[None](position: Pointer[V3] tag, width: F32, height: F32, length: F32, color: Color)
use @PonyDrawCubeWiresV[None](position: Pointer[V3] tag, size: Pointer[V3] tag, color: Color)
use @PonyDrawSphere[None](centerPos: Pointer[V3] tag, radius: F32, color: Color)
use @PonyDrawSphereEx[None](centerPos: Pointer[V3] tag, radius: F32, rings: I32, slices: I32, color: Color)
use @PonyDrawSphereWires[None](centerPos: Pointer[V3] tag, radius: F32, rings: I32, slices: I32, color: Color)
use @PonyDrawCylinder[None](position: Pointer[V3] tag, radiusTop: F32, radiusBottom: F32, height: F32, slices: I32, color: Color)
use @PonyDrawCylinderEx[None](startPos: Pointer[V3] tag, endPos: Pointer[V3] tag, startRadius: F32, endRadius: F32, sides: I32, color: Color)
use @PonyDrawCylinderWires[None](position: Pointer[V3] tag, radiusTop: F32, radiusBottom: F32, height: F32, slices: I32, color: Color)
use @PonyDrawCylinderWiresEx[None](startPos: Pointer[V3] tag, endPos: Pointer[V3] tag, startRadius: F32, endRadius: F32, sides: I32, color: Color)
use @PonyDrawCapsule[None](startPos: Pointer[V3] tag, endPos: Pointer[V3] tag, radius: F32, slices: I32, rings: I32, color: Color)
use @PonyDrawCapsuleWires[None](startPos: Pointer[V3] tag, endPos: Pointer[V3] tag, radius: F32, slices: I32, rings: I32, color: Color)
use @PonyDrawPlane[None](centerPos: Pointer[V3] tag, size: Pointer[V2] tag, color: Color)
use @PonyDrawRay[None](ray: Pointer[R2] tag, color: Color)
...
use @PonyDrawModel[None](model: Model, position: Pointer[V3] tag, scale: F32, tint: Color)
use @PonyDrawModelEx[None](model: Model, position: Pointer[V3] tag, rotationAxis: Pointer[V3] tag, rotationAngle: F32, scale: Pointer[V3] tag, tint: Color)
use @PonyDrawModelWires[None](model: Model, position: Pointer[V3] tag, scale: F32, tint: Color)
use @PonyDrawModelWiresEx[None](model: Model, position: Pointer[V3] tag, rotationAxis: Pointer[V3] tag, rotationAngle: F32, scale: Pointer[V3] tag, tint: Color)
use @PonyDrawBoundingBox[None](box': BoundingBox, color: Color)
use @PonyDrawBillboard[None](camera: Camera, texture: Texture2D, position: Pointer[V3] tag, size: F32, tint: Color)
use @PonyDrawBillboardRec[None](camera: Camera, texture: Texture2D, source: Rectangle, position: Pointer[V3] tag, size: Pointer[V2] tag, tint: Color)
use @PonyDrawBillboardPro[None](camera: Camera, texture: Texture2D, source: Rectangle, position: Pointer[V3] tag, up: Pointer[V3] tag, size: Pointer[V2] tag, origin: Pointer[V2] tag, rotation: F32, tint: Color)
...
use @PonyGenMeshHeightmap[Mesh](heightmap: Image, size: Pointer[V3] tag)
use @PonyGenMeshCubicmap[Mesh](cubicmap: Image, cubeSize: Pointer[V3] tag)
...
use @PonyCheckCollisionSpheres[Bool](center1: Pointer[V3] tag, radius1: F32, center2: Pointer[V3] tag, radius2: F32)
use @PonyCheckCollisionBoxes[Bool](box1: BoundingBox, box2: BoundingBox)
use @PonyCheckCollisionBoxSphere[Bool](box': BoundingBox, center: Pointer[V3] tag, radius: F32)
use @PonyGetRayCollisionSphere[RayCollision](ray: Pointer[R2] tag, center: Pointer[V3] tag, radius: F32)
use @PonyGetRayCollisionBox[RayCollision](ray: Pointer[R2] tag, box': BoundingBox)
use @PonyGetRayCollisionMesh[RayCollision](ray: Pointer[R2] tag, mesh: Mesh, transform: Matrix)
use @PonyGetRayCollisionTriangle[RayCollision](ray: Pointer[R2] tag, p1: Pointer[V3] tag, p2: Pointer[V3] tag, p3: Pointer[V3] tag)
use @PonyGetRayCollisionQuad[RayCollision](ray: Pointer[R2] tag, p1: Pointer[V3] tag, p2: Pointer[V3] tag, p3: Pointer[V3] tag, p4: Pointer[V3] tag)
...
struct Transform
  ...
  new create(translation': V3, rotation': Q4, scale': V3) =>
...
struct RayCollision
  ...
  new create(hit': Bool, distance': F32, point': V3, normal': V3) =>
    hit = hit'
    distance = distance'
    point = point'
    normal = normal'
